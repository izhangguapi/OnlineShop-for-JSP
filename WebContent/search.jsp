...
String sql = "SELECT * FROM commodities t1 inner join commoditiestype t2 on t1.typeid=t2.typeid WHERE t1.name LIKE '%"+name+"%' AND state=TRUE";
          ...
          <div class="row">
            ...
            <div class="col-6 col-sm-4 col-lg-3">
              <div class="card top-product-card mb-3">
                <div class="card-body"><a class="product-thumbnail d-block" href="detailed.jsp?src=<%=currentCommodity.getPicture()%>&name=<%=currentCommodity.getName()%>&cid=<%=currentCommodity.getCommodityid()%>&p=<%=currentCommodity.getPrice()%>">
                <img class="mb-2" src="<%=currentCommodity.getPicture()%>" alt=""></a><a class="product-title d-block"><%=currentCommodity.getName()%></a>
                  ...
                  <a href="addcart?uid=<%=uid%>&cid=<%=currentCommodity.getCommodityid()%>&name=<%=name %>" class="btn btn-success btn-sm add2cart-notify">
