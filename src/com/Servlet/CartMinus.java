...
@WebServlet("/cartminus")
public class CartMinus extends HttpServlet{
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		...
		if(num == 0 ) {
			String sql = "DELETE FROM cart WHERE userid='"+uid+"' and commodityid='"+cid+"'";
			...
			String sql = "UPDATE cart SET number="+(num-1)+" WHERE userid='"+uid+"' and commodityid='"+cid+"'";
			int state = DBHelper.executeUpdate(sql);
			if(state == 0){ 
